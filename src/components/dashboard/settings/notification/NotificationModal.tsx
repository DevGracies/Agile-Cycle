        ...
        <div className="flex items-center justify-between border-b border-[#EEF1EC] px-6 py-5">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Full notification activity information.
            </p>
          </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-2xl bg-[#F8FAF7] border border-[#EEF1EC] p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="font-medium text-[#111827]">Event Trigger</p>
            </div>

            <p className="text-gray-600">{selectedLog.trigger}</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="rounded-2xl bg-[#F8FAF7] border border-[#EEF1EC] p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="font-medium text-[#111827]">Recipient</p>
              </div>

              <p className="text-gray-600">{selectedLog.recipient}</p>
            </div>
